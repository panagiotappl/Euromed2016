                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <?php if(!empty($_SESSION['fail']) && $_SESSION['fail']){
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box">
                                ...
                                <?php if(!empty($_SESSION['regfail']) && $_SESSION['regfail']){
                                echo  '<div class="alert alert-danger">
                                ...
                                <div class="form-group">
                                  <label class="sr-only" for="form-passwordR">Repeat Password</label>
                                  <input type="password" name="form-passwordr" placeholder="Repeat password..." class="form-username form-control" id="form-username">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="date" name="form-date-of-birth" placeholder="Date of Birth..." class="form-birth form-control" id="form-birth">
                                </div>
                                <div class="form-group">
                                  <label class="sr-only" for="form-mobile">Mobile</label>
                                  <input type="text" name="form-mobile" placeholder="Mobile..." class="form-email form-control" id="form-email">
                                </div>
                                <div class="form-group">
